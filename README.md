...
But after using it myself for a week, the pros and cons became apparent. Although it can be used seamlessly on a daily basis, its accuracy to detect a hand washing gesture still needs to be improved. Its reliance on the Apple Watch also limits the number of people that can use it. But overall, it does help remind me to wash my hands and it remains to be one of the best ways for Apple Watch users to create a habit of washing their hands.
